...
@Repository	//will create singleton object
public class UserRepositoryimpl implements UserRepository {

	@Autowired	//it will bring your already created object either by using name or type
	DataSource dataSource;
	@Autowired
	public LoginRepository loginRepository;// = LoginRepositoryImpl.getInstance();
	...
	public String addUser(Register register) {
		...
		try {
			...
			if(result>0) {
				...
				login.setRole(ROLE.values()[new Random().nextInt(2)]);
